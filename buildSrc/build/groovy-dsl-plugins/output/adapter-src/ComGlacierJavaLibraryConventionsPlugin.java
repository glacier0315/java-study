...
/**
 * Precompiled com.glacier.java-library-conventions script plugin.
 **/
public class ComGlacierJavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComGlacierJavaLibraryConventions").asSubclass(BasicScript.class);
