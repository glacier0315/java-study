...
/**
 * Precompiled com.glacier.java-application-conventions script plugin.
 **/
public class ComGlacierJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        assertSupportedByCurrentGradleVersion();
                target.getPluginManager().apply("com.glacier.java-common-conventions");
        target.getPluginManager().apply("application");

        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComGlacierJavaApplicationConventions").asSubclass(BasicScript.class);
